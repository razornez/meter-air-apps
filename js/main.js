...
(function(undefined) {
    ...
    var args = {
        ...
        resultFunction: function(res) {
            ...
            // scannedQR[val_] = res.format + ": " + res.code;
            scannedQR[val_] = res.code;
            window.open('customer/scan/'+res.code+'','_self');
        },
    ...
    Page.changeZoom = function(a) {
        ...
        // window.open('customer/scan/200212001','_self');
    };
    ...
    document.querySelector("#camera_switch").addEventListener("click", function() {
        console.log(decoder.isInitialized());
        if (decoder.isInitialized()) {
            decoder.stop().play();
        }
    });
