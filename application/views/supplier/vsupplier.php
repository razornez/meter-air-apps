<div class="main-panel">
  <div class="row">
        ...
        <div class="col-12 stretch-card" style="padding-top: 5px;">
          <div class="card">
            <div class="card-body">
              ...
              <form action="<?php echo base_url(). 'supplier/add_aksi'; ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                <label class="col-md-4 control-label label-produk" for="name">Nama</label>
                  <div class="col-md-12">
                    <input id="nama" name="nama" type="text" placeholder="PD. ABC" class="form-control" >
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-4 control-label label-produk" for="name">Alamat</label>
                  <div class="col-md-12">
                    <textarea id="alamat" name="alamat" class="form-control" placeholder="Jl. Peta Bandung 40377"></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-4 control-label label-produk" for="name">telepon</label>
                  <div class="col-md-12">
                    <input id="telepon" name="telepon" type="number" placeholder="02281273822" class="form-control" maxlength="15" >
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-4 control-label label-produk" for="name">Keterangan</label>
                  <div class="col-md-12">
                    <textarea id="keterangan" name="keterangan" class="form-control" placeholder="Distributor Kayu"></textarea>
                  </div>
                </div>

                <div class="form-group">
                  <label class="col-md-6 control-label label-produk" for="name">Foto/Logo Supplier</label>
                  <div class="col-md-12">
    ...
    <div class="col-md-8 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title"><i class="fa fa-list-alt"></i>&nbsp&nbspData Supplier</h4>
          <form action="<?=base_url()?>supplier/cari" method="get" style="padding: 10px;margin-bottom: 0px;">
            <div class="row">
              <div class="col-md-4">
          ...
          <p class="card-description">Jumlah data keseluruhan <?php echo $this->Msupplier->count_data() ?> Record</p>
            ...
            <!-- <div class="jsgrid-grid-header jsgrid-header-scrollbar"> -->
              <table class="jsgrid-table">
                <tr class="jsgrid-header-row">
                  ...
                  <th class="jsgrid-header-cell jsgrid-align-center jsgrid-header-sortable" style="width: 100px;">Telepon</th>
                  <th class="jsgrid-header-cell jsgrid-header-sortable" style="width: 200px;">Keterangan</th>
              ...
              <table class="jsgrid-table">
                ...
                foreach ($datasupplier as $data) { ?>
                  <tr class="jsgrid-row">
                    ...
                    <td class="jsgrid-cell" style="width: 100px;"><?php echo $data->telepon ?></td>
                    <td class="jsgrid-cell jsgrid-align-left" style="width: 200px;"><?php echo $data->keterangan ?></td>
                      ...
                      <div class="modal hide" id="modalDelete<?=$data->id?>">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <form action="<?=base_url()?>supplier/delete/<?=$data->id?>" method="post">
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header" style="padding: 12px;">
                          ...
                          <form action="<?php echo base_url(). 'supplier/update_aksi'; ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                              <label class="col-md-4 control-label label-produk" for="name">Nama</label>
                              <div class="col-md-12">
                                <input id="id_supplier" name="id_supplier" type="hidden" value="<?php echo $data->id ?>">
                                <input id="pop_nama" name="pop_nama" type="text" placeholder="PD. ABC" value="<?php echo $data->nama ?>" class="form-control" style="width: 100%;">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-md-4 control-label label-produk" for="name">Alamat</label>
                              <div class="col-md-12">
                                <textarea id="pop_alamat" name="pop_alamat" class="form-control" placeholder="Jl. Peta Bandung 40477" style="width: 100%;"><?php echo $data->alamat ?></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-md-4 control-label label-produk" for="name">telepon</label>
                              <div class="col-md-12">
                                <input id="pop_telepon" name="pop_telepon" type="number" placeholder="02281273822" value="<?php echo $data->telepon ?>" class="form-control" maxlength="15" style="width: 100%;">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-md-4 control-label label-produk" for="name">Keterangan</label>
                              <div class="col-md-12">
                                <textarea id="pop_keterangan" name="pop_keterangan" class="form-control" placeholder="Distributor Kayu" style="width: 100%;"><?php echo $data->keterangan ?></textarea>
                              </div>
                            </div>

                            <div class="form-group">
                              <label class="col-md-4 control-label label-produk" for="name">Foto/Logo Supplier</label>
                              <div class="col-md-12">
                                <?php if ($data->foto != '-'){ ?>
                                <img style="width:100px;" id="blah" src="<?php echo base_url().'img/'.$data->foto ?>" alt="your image" /><br><br>
                                <?php }else{ ?>
