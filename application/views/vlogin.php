          ...
          <div class="col-12 col-md-8 h-100 bg-white">
            <div class="auto-form-wrapper d-flex align-items-center justify-content-center flex-column">
              <!-- <div class="nav-get-started">
               ...
               <form role="form" class="col-form" action="<?php echo base_url(); ?>login/cekLogin" method="POST">
                <h3 class="mr-auto">APLIKASI</h3>
                ...
                <div class="wrapper mt-5 text-gray">
                  <p class="footer-text">Copyright © 2020 <?php echo $this->Mconfig->get_config()->row()->perusahaan ?>. All rights reserved.</p>
