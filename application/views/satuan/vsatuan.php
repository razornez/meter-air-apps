<div class="main-panel">
  <div class="row">
        ...
        <div class="col-12 stretch-card" style="padding-top: 5px;">
          <div class="card">
            <div class="card-body">
              ...
              <form action="<?php echo base_url(). 'satuan/add_aksi'; ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label class="col-md-4 control-label label-satuan">Nama</label>
                  <div class="col-md-12">
                    <input id="nama" name="nama" type="text" placeholder="Kg" class="form-control" Required>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-md-4 control-label label-satuan">Deskripsi</label>
                  <div class="col-md-12">
                    <input id="deskripsi" name="deskripsi" type="text" placeholder="Kilogram" class="form-control" Required>
                  </div>
                </div>
    ...
    <div class="col-md-8 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title"><i class="fa fa-list-alt"></i>&nbsp&nbspData satuan</h4>
          <form action="<?=base_url()?>satuan/cari" method="get" style="padding: 10px;margin-bottom: 0px;">
            <div class="row">
              <div class="col-md-4">
          ...
          <p class="card-description">Jumlah data keseluruhan <?php echo $this->Msatuan->count_data() ?> Record</p>
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header" style="padding: 12px;">
                          ...
                          <form action="<?php echo base_url(). 'satuan/update_aksi'; ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                              <label class="col-md-4 control-label label-satuan">Nama</label>
                              <div class="col-md-12">
                              <input id="id_satuan" name="id_satuan" type="hidden" value="<?php echo $data->id ?>">
                              <input id="pop_nama" name="pop_nama" type="text" value="<?php echo $data->nama ?>" placeholder="Kg" class="form-control" Required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-md-4 control-label label-satuan">Deskripsi</label>
                              <div class="col-md-12">
                                <input id="pop_deskripsi" name="pop_deskripsi" type="text" value="<?php echo $data->deskripsi ?>" placeholder="Kilogram" class="form-control" Required>
                              </div>
                            </div>
                          <div class="modal-footer">
