...
<!-- Mirrored from www.urbanui.com/radiant/jquery/pages/samples/login-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 16 May 2018 01:25:54 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="utf-8">
          ...
          <div class="col-md-4 banner-section d-none d-md-flex align-items-stretch justify-content-center">
            <div class="slide-content bg-1">
              <div class="logo-login-page">
                <center><img src="<?php echo base_url(); ?>img/<?php echo $this->Mconfig->get_config()->row()->logo ?>" style="width: 200px;padding-top: 20px;"></center>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-8 h-100 bg-white">
            <div class="auto-form-wrapper d-flex align-items-center justify-content-center flex-column">
              <div class="nav-get-started">
               ...
               <form role="form" class="col-form" action="<?php echo base_url(); ?>login/cekLogin_app" method="POST">
                <h3 class="mr-auto">Aplikasi Kasir</h3>
                <p class="mb-5 mr-auto"><?php echo $this->Mconfig->get_config()->row()->perusahaan ?></p>
                ...
                <div class="wrapper mt-5 text-gray">
                  <p class="footer-text">Copyright © 2018 <?php echo $this->Mconfig->get_config()->row()->perusahaan ?>. All rights reserved.</p>
